...
insert  into `section`(`id`,`name`,`count`,`address`) values (1,'开发部',20,NULL),(2,'测试部',20,NULL),(3,'销售部',NULL,NULL),(4,'其他部',10,NULL);
